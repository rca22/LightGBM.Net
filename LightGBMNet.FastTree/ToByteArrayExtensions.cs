...
namespace LightGBMNet.FastTree
{
    ...
    public static class ToByteArrayExtensions
    {
        ...
        public static int SizeInBytes(this byte[] a)
        {
            return sizeof(int) + Size(a) * sizeof(byte);
        }
        ...
        public static int SizeInBytes(this short[] a)
        {
            return sizeof(int) + Size(a) * sizeof(short);
        }
        ...
        public static int SizeInBytes(this ushort[] a)
        {
            return sizeof(int) + Size(a) * sizeof(ushort);
        }
        ...
        {
            return sizeof(int) + Size(array) * sizeof(int);
        }
        ...
        {
            return sizeof(int) + Size(array) * sizeof(uint);
        }
        ...
        {
            return sizeof(int) + Size(array) * sizeof(long);
        }
        ...
        {
            return sizeof(int) + Size(array) * sizeof(ulong);
        }
        ...
        //{
        //    return sizeof(int) + Size(array) * MD5Hash.SizeInBytes();
        //}
        ...
        {
            return sizeof(int) + Size(array) * sizeof(float);
        }
        ...
        {
            return sizeof(int) + Size(array) * sizeof(double);
        }
        ...
        public static void ToByteArray(this string[] a, byte[] buffer, ref int position)
        {
            Size(a).ToByteArray(buffer, ref position);
