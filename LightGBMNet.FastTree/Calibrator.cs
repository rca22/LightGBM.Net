...
namespace LightGBMNet.FastTree
{
        ...
        //ICanGetSummaryInKeyValuePairs
    {
        ...
        protected CalibratedPredictorBase(IPredictorProducing<Float> predictor, ICalibrator calibrator)
        {
    ...
    public abstract class ValueMapperCalibratedPredictorBase : CalibratedPredictorBase, IPredictorProducing<Float>
        //, IValueMapperDist, IWhatTheFeatureValueMapper, IDistCanSavePfa, IDistCanSaveOnnx
    {
        ...
        protected ValueMapperCalibratedPredictorBase(IPredictorProducing<Float> predictor, ICalibrator calibrator)
    ...
    public sealed class CalibratedPredictor : ValueMapperCalibratedPredictorBase
    {
        public CalibratedPredictor(IPredictorProducing<Float> predictor, ICalibrator calibrator)
            : base(predictor, calibrator)
        {
        }
        ...
        //ICanSaveModel
    {
        ...
        public FeatureWeightsCalibratedPredictor(IPredictorWithFeatureWeights<Float> predictor,
            ICalibrator calibrator)
            : base(predictor, calibrator)
        {
    ...
    public sealed class PlattCalibrator : ICalibrator
    {
        ...
        public PlattCalibrator(Double paramA, Double paramB)
        {
            ParamA = paramA;
            ParamB = paramB;
        }
